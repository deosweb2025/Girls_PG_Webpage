  ...
  return (
    ...
    >
      ...
      <a
        ...
        aria-label="Chat with Ajanta Ladies PG on WhatsApp"
      ...
      >
        ...
        <MessageCircle className="w-5 h-5 sm:w-5 sm:h-5 shrink-0" />
      ...
      <a
        ...
        aria-label={`Call Ajanta Ladies PG at ${siteData.contact.displayPhone}`}
